...
import FormNewVenta from "../components/FormNewVenta";
    ...
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      <main className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <ResumenCard title="Total Ventas" value="3" color="bg-gray-200" icon="📋" />
        ...
        {/* MODAL */}
        <FormNewVenta open={openModal} onClose={() => setOpenModal(false)} />
      </main>
    </div>
  );
}